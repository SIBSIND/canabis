...
<p></p>
<?php wp_reset_postdata(); $posts = get_posts ("post_type=post&category=9&order=desc"); ?>
<?php if ($posts) { ?>
...
<br>
    ...
    <script>
        Jquery(document).ready(function(){
            Jquery(".table .price_num").text(function(index, text) {
                return text.replace(" Create your own review.", " Оставить отзыв");
            });
        });
    </script>
